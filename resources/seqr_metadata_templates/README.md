...
To enable the CPG to process and display your genomic data in seqr we require some additional information about the genomic data and the individuals it was generated from. This document provides instructions on how to prepare project-specific data and metadata for use in seqr.
...
1.1&emsp;CPG’s bioinformatic pipelines use the following genomic data types:
...
|     Affected Status    | -9 = missing<br />0 = missing<br />1 = unaffected<br />2 = affected | Either -9 or 0 can be used to denote a missing affected status for an individual.    |
...
| Death Year | Numeric year of death, if applicable. <br /> Leave blank otherwise. | If you have collected a DOD, e.g. 01-01-2001, please only include the **year** component. |
| Age of Onset | **One of the following:** <br /><br />Congenital onset, <br />Embryonal onset, <br />Fetal onset, <br />Neonatal onset, <br />Infantile onset, <br />Childhood onset, <br />Juvenile onset, <br />Young adult onset, <br />Adult onset, <br />Middle age onset, <br />Late onset | *This is a rough suggestion, with no clinical source.*<br /> <br /> **Congenital onset:** conception to birth <br /> **Embryonal onset:** conception to 8 wks gestation <br /> **Fetal onset:** 9 wks gestation to birth<br />  **Neonatal onset:** birth to 1 month, <br /> **Infantile onset:** birth to 1 year<br /> **Childhood onset:** < 5 years<br /> **Juvenile onset:** < 17 years<br /> **Young adult onset:** < 25 years<br /> **Adult onset:** < 36 years<br /> **Middle age onset:** < 55 years<br /> **Late onset:** > 55 years
...
| **Field label** | **Allowed Values** | **Notes** |
|:---:|:---:|---|
| Individual ID | Alphanumeric individual ID <br>(if different to the Sample ID)    | This column can be left blank if the individual ID and the sample ID are identical.    |
